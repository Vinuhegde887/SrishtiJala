    ...
    return (
      <>
        <div className="flex items-center justify-center h-screen">
          <Loader2Icon className="size-7 animate-spin text-black-200" />
        </div>
      </>
    )
  }
    ...
    <div className='flex flex-col h-screen w-full bg-gray-900 text-white'>
      ...
      no-scrollbar'>
        ...
        <img src="/favicon.svg" alt="logo" className="h-6 cursor-pointer"
          ...
          <div className='sm:hidden flex-1 flex justify-end'>
            ...
            <MessageSquareIcon onClick={()=> setIsMenuOpen(false)}
             ...
             :<XIcon onClick={()=> setIsMenuOpen(true)} className="
        ...
        <div className='flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm'>
          ...
          <Link  target='_blank' to={`/preview/${projectId}`} className='
          flex itesm-center gap-2 px-4 py-1 rounded sm:rounded-sm border
          border-gray-700 hover:border-gray-500 transition-colors'>
            ...
            hover:from-blue-600 hover:to-blue-500 text-white px-3.5 py-1 flex items-center gap-2 rounded 
            ...
            hover:from-indigo-600 hover:to-indigo-500 text-white px-3.5 py-1 flex items-center gap-2 rounded 
            sm:rounded-sm transition-colors'>
              {project.isPublished ? 
