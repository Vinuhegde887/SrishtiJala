          ...
          <div className="py-10 min-h-[80vh]">
            ...
            <div className='flex flex-wrap gap-3.5'>
              {projects.map((project)=>(
                ...
                max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden shadow-md group
                hover:shadow-indigo-700/30 hover:border-indigo-800/80 transition-all duration-300'>
                  ...
                  border-b border-gray-800'>
                    {project.current_code ?(
                      ...
                      className='absolutr top-0 left-0 w-[1200px]
                  ...
                  :(
                    ...
                    {/*content*/}
                    <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent
                    transition-colors'>
                      <div className='flex items-start justify-between'>
                        <h2 className='trext-lg fornt-medium line-clamp-2'>
                          {project.name}</h2>
                  ...
                  <div onClick={(e)=>e.stopPropagation()} className='flex justify-between items-center4 mt-6'>
